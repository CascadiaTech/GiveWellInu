...
export const ConnectWallet = () => {
  ...
  const walletconnect = new WalletConnectConnector({
    supportedChainIds: [1, 3, 4, 5, 42, 11155111],
    rpc: { 1: `https://mainnet.infura.io/v3/ae657ccfd6f346a0bddcd7cc9d49b2de`, 5: `https://goerli.infura.io/v3/ae657ccfd6f346a0bddcd7cc9d49b2de` },
    bridge: "https://bridge.walletconnect.org",
    qrcode: true,  
  });

  const CoinbaseWallet = new WalletLinkConnector({
    url: `https://mainnet.infura.io/v3/ae657ccfd6f346a0bddcd7cc9d49b2de`,
    appName: "Web3",
    supportedChainIds: [1, 3, 4, 5, 42, 11155111],
  });
    ...
    <div>
      {active ? (
        <button
          ...
          className="text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-3 mt-3 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
        >
          Disconnect Wallet
        </button>
      ) : (
        <div>
          <button
            ...
            onClick={OnClick}
            style={{ fontFamily:'Aquire' }}
            className="text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-blue-300 font-medium mt-2 rounded-lg text-sm px-5 py-2.5 mb-2 mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
          >
            Connect Wallet
          </button>
